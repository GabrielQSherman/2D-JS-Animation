...
window.onload = function() {
	...
	let canvas = document.getElementById("canvas"),
		...
		width = canvas.width = window.innerWidth-77,       //width of the canvas
        height = canvas.height = window.innerHeight-77,   //height of the canvas
        ...
        originx = 333, originy = 222,  //if these vars' values are modified the grid starting position will also be modified 
        ...
        function animate() {
            ...
            // size-=.3141; //uncomment this then comment the line below out
            size -= size * .01 
        ...
        function create_square(p1,p2,p3,p4) { //this function creates the square line by line. and will then fill the shape with either white or black
            ...
            //This will create random colors (360 is the full spectrum)
            // context.fillStyle = 'hsl(' + (Math.random() * 360) + ', 100%, 77%)';

            if (startWithWhite) {
                context.fillStyle = 'Aquamarine'; // find all the colors @ w3schools.com/colors/colors_names.asp 
                context.fill();
        ...
        function create_row(){
            ...
            while (columnCycles < columnLimit) { //it will contiue to make new square every time it 
